...
const FALLBACK_PROJECTS = [
  // Cinematic
  { id: "c1", title: "FINAL SHI-2", slug: "cinematic-final-shi-2", category: "cinematic", videoUrl: "/videos/cinematic/FINAL SHI-2.mp4", thumbnailUrl: null, aspectRatio: "16:9", featured: false, sortOrder: 0, description: null, caseStudy: null, beforeUrl: null, afterUrl: null },
  { id: "c2", title: "LUMA NA MAGAYON", slug: "cinematic-luma-na-magayon", category: "cinematic", videoUrl: "/videos/cinematic/LUMA NA MAGAYON.mp4", thumbnailUrl: null, aspectRatio: "16:9", featured: false, sortOrder: 1, description: null, caseStudy: null, beforeUrl: null, afterUrl: null },
  { id: "c3", title: "LUMA NA PANGIT", slug: "cinematic-luma-na-pangit", category: "cinematic", videoUrl: "/videos/cinematic/LUMA NA PANGIT.mp4", thumbnailUrl: null, aspectRatio: "16:9", featured: false, sortOrder: 2, description: null, caseStudy: null, beforeUrl: null, afterUrl: null },
  // AMV / Experiments
